  ...
  return (
    <WeddingLayout>
      <section className="animate-fade-in">
        <h2 className="text-3xl md:text-4xl font-greatvibes text-[#b76e79] mb-6 text-center">Detalles de la boda</h2>
        <div className="bg-[#ffe4e1] rounded-xl p-6 shadow-sm mb-6">
          <h3 className="text-xl font-semibold mb-2 text-[#b76e79]">Ceremonia</h3>
